...
export function GalleryCard({ art, title, artist, year }: GalleryCardProps) {
  return (
    <div className="group relative h-[380px] min-w-[280px] overflow-hidden border border-codex-gold/60 bg-codex-dark/70 shadow-gilded transition-transform duration-500 hover:scale-[1.03]">
      <div className="relative h-[70%]">
        <Image src={art} alt={title} fill className="object-cover transition-transform duration-700 group-hover:scale-[1.08]" sizes="280px" />
      </div>
